...
class CardsController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // verificando se obteve registros para listar
        if ($card) {
            // retornando resposta de card criado
    ...
    public function delete($id) {
        ...
        if ($card->delete()) {
            // apos excluir o registro precisamos retornar para a listagem de cartoes em index.blade.php porem teremos que obter todos os registros da tabela cards para que nao tenhamos erros ao renderizar a view index, afinal de contas ela percorre um array $cards para montar a listagem de cards dentro de uma table
